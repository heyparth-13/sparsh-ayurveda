...
export default function AdminPage() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    e.preventDefault();
    if (passcode.toLowerCase() === "sparksweda" || passcode.toLowerCase() === "sparshveda") {
      setIsAuthenticated(true);
      setAuthError("");
    } else {
      setAuthError("Invalid passcode. Hint: Use 'sparshveda'");
    }
  };
              ...
              <form onSubmit={handleLogin} className={styles.loginForm}>
                ...
                <div className={styles.formGroup}>
                  ...
                  <input
                    ...
                    type="password"
                    required
                    placeholder="Enter passcode (hint: sparshveda)"
                    value={passcode}
